...
public class UI {
		...
		do {
			...
			case 3:
				...
				try {
					...
					System.out.println("Kein Projekt zum Loeschen gefunden.");
				}
				pressAnyKey();
				break;

			case 4:
				System.out.println("*** Statusberichte fuer Projekt ausgeben ***\n");
	...
	private static void credits() {
		...
		System.out.println(" - Eyuep Uenlue");
		System.out.println(" - Mike Moeck");
